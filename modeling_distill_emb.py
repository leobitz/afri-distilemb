...
from loss_fns import info_nce_loss_v2
...
class BertForEmbeddingLM(BertPreTrainedModel):
    ...
    def forward(
        ...
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
        postive_embeddings: Optional[torch.Tensor] = None,
        ...
        masked_lm_loss = None
        if postive_embeddings is not None:
            masked_lm_loss = info_nce_loss_v2(sequence_output, postive_embeddings)
