pip install lightning transformers datasets==3.6 sentencepiece gdown torch==2.8.0 scikit-learn pandas huggingface_hub emoji wandb accelerate
git clone https://github.com/afrisenti-semeval/afrisent-semeval-2023.git downstream-data/afrisent-semeval-2023
